...
const stuff = [
  ...
  `Suicide bombs, waves of refugees, Donald Trump, Vladimir Putin, even Brexit.`,
  ...
  `The bankers enforced what was called "austerity"`,
  `On the city, insisting that thousands of teachers, policemen and firemen were sacked.`,
  ...
  `They believed that instead of trying to change the world outside the new radicalism should try and change what was inside people's heads.`,
  `And the way to do this was through self-expression, not collective action.`,
  `But some of the Left saw that something else was really going on - that by detaching themselves and retreating into an ironic coolness.`,
  `A whole generation were beginning to lose touch with the reality of power.`,
  `One of them wrote of that time, "It was the mood of the era and the revolution was deferred indefinitely."`,
  ...
  `And like in New York, it was going to be a struggle between the old idea of using politics to change the world.`,
  ...
  `He wanted to find a way of uniting the Arab countries and using that power to stand up to the West.`,
  ...
  `But what Kissinger took from the Cold War was a way of seeing the world as an interconnected system.`,
  `And his aim was to keep that system in balance and prevent it from falling into chaos.`,
  ...
  `But at the same time, he led Assad to believe that he was working for a wider peace agreement, one that WOULD include the Palestinians.`,
  ...
  `In a series of confrontations with Kissinger in Damascus, Assad raged about this treachery.`,
  ...
  `"Assad's controlled fury," he wrote, "was all the more impressive for its eerily cold, seemingly unemotional, demeanour."`,
  `Assad now retreated.`,
  ...
  `[EXPLOSION]`,
  `Israel was now determined to finally destroy the power of the Palestinians.`,
  `And, in 1982, they sent a massive army to encircle the Palestinian camps in the Lebanon.`,
  `"Do you know..."`,
  `"Do you know how strong the Israelis are?"`,
  ...
  `In the face of the horror and the growing chaos, President Reagan was forced to act.`,
  ...
  `And what Khomeini could bring to Assad was an extraordinary new weapon that he had just created.`,
  `It was called "the poor man's atomic bomb".`,
  `[CHANTING: ]`,
  ...
  `"And it was a black... black marine. He looked white. The dust had just covered him."`,
  ...
  `"So, it is to Syria rather than to the dissident group's guiding light, Ayatollah Khomeini of Iran, that we must look for an explanation of the group's activities."`,
  ...
  `But despite his words, within four months, President Reagan withdrew all the American troops from the Lebanon.`,
  ...
  `By the middle of the 1980s, the banks were rising up and becoming ever more powerful in America.`,
  ...
  `Instead of cyberspace being a frightening place, dominated by powerful corporations, they reinvented it as the very opposite.`,
  ...
  `"An LSD society, there will be less interest in, obviously, warfare, in power politics."`,
  ...
  `"OK."`,
  `"That is good."`,
  `"And it immediately acquired a financial quality or a commercial quality that was initially a little unsettling to an old hippy like me."`,
  `"But as soon as I saw it actually working, then I thought, 'Ah, well, if you're going to have an acid test for the '90s money better be involved.'"`,
  ...
  `"Among a number of things having to do with computer trespass and... And I guess computer eavesdropping, interception."`,
  ...
  `Faced with the humiliating defeat in the Lebanon, President Reagan's government was desperate to shore up the vision of a moral world where a good America struggled against evil.`,
  ...
  `The perfect candidate was waiting in the wings, Colonel Gaddafi, the ruler of Libya.`,
  ...
  `"You had the best months." [HE CHUCKLES]`,
  ...
  `"The Rome and Vienna murders are only the latest in a series of brutal terrorist acts committed with Gaddafi's backing."`,
  ...
  `He grabbed the publicity that had been given to him by the Americans and used it dramatically.`,
  ...
  `"Brothers and sisters, it is with great honor and privilege that I present to you the leader of the al-Fateh Revolution from Libya, our brother Muammar al-Gaddafi."`,
  `[APPLAUSE]`,
  ...
  `"If white America refuses to accept blacks as US citizens," he told them, "it must therefore be destroyed."`,
  ...
  `Gaddafi became a global supervillain, at the head of what was called a "rogue state"`,
  ...
  `"There's less Arab support for Gaddafi, we figured there would be less Soviet support for Gaddafi."`,
  ...
  `Immediately after the attack, Gaddafi appeared in the ruins to describe what had happened.`,
  `[TRANSLATION]`,
  ...
  `"Holy crap! It's just moving really slowly."`,
  `"Wow! Look, look, look! Come here, come here! What is it doing?"`,
  `"What the heck?! Guys, it's..."`,
  `"Whoa! Oh, my gosh! Wow! What is happening?"`,
  `"Dude, what is happening?! What is going on?"`,
  `"Oh, my gosh! Oh, my God, guys!"`,
  ...
  `What the Reagan administration were doing, both with Colonel Gaddafi and with the UFOs, was a blurring of fact and fiction but it was part of an even broader program.`,
  ...
  `The aim was to tell dramatic stories that grabbed the public imagination, not just about the Middle East, but about Central America and the Soviet Union. `,
  `And it didn't matter if the stories were true or not, providing they distracted people and you, the politician, from having to deal with the intractable complexities of the real world.`,
  ...
  `"That's it! Whoo! Get ready to work out."`,
  `[GUNSHOTS]`,
  ...
  `Back in 1986, Mr. Fink's career had collapsed.`,
  `"Shoot!"`,
  ...
  `"I'm going to witness 4 billion shares change hands on the New York Stock Exchange."`,
  ...
  `"And then, all of a sudden, here comes somebody that says, 'OK, now try these on.'"`,
  `"Try this Prozac on."`,
  `"And I tried it on and for the first time in my life I went, 'Whoa! Is this the way reality really is?'"`,
  ...
  `"And then your doctor, every time you come back, says, 'You're looking so much better.'"`,
  `"And then every time I go in he goes, 'You're so beautiful.'"`,
  `"You know?"`,
  ...
  `"I think, 'Yeah, I do.'"`,
  `"So, I go out and tell my friends, 'I feel so much better about myself.'"`,
  ...
  `Scientists then spent years trying to program the rules that governed human thought...`,
  ...
  `He was called Joseph Weizenbaum and he built what he claimed was a computer psychotherapist.`,
  `Just like a therapist, people could come and talk to the machine by typing in their problems.`,
  `Weizenbaum called the program "Eliza".`,
  ...
  `The patient sat in front of the screen and typed in what they were feeling and the program repeated it back to them, often in the form of a question.`,
  ...
  `And yet she knew, as Weizenbaum did, that Eliza didn't understand a single word that was being typed into it.`,
  ...
  `Finance promised that it could control the unpredictability of the free market...`,
  `While individuals were more and more monitored to stabilise their physical and mental states.`,
  ...
  `[IN JAPANESE]`,
  `Before Kashiwagi could pay his debt, he was hacked to death in his kitchen by Yakuza gangsters...`,
  ...
  `"The bombing had been done," they said, "in revenge for the Americans "shooting down an Iranian airliner in the Gulf a few months before."`,
  ...
  `They were targeting civilians, something Hezbollah had never done.`,
  ...
  `"And," he added, "it was also justified to kill civilians, "because, in Israel, everyone - "including women - serve as reservists.`,
  ...
  `"And that is their ability to turn their bodies into bombs like the Palestinians do."`,
  ...
  `But even with the first grief came the immediate political impact on the peace process.`,
  `"Peace impossible! This moment, it will be the end! It must be the end of this bloody peace process."`,
  `And, in America, all optimistic visions of the future had also disappeared.`,
  ...
  `To Saddam Hussein's chemical weapons program which was making vast quantities of VX and sarin nerve agents.`,
  ...
  `A later report into the Iraq War pointed out, "Glass containers were not typically used in chemical munitions..."`,
  `"Seizes your nervous system... Do not move that!"`,
  `And the informant had obviously seen a popular movie known as The Rock that had inaccurately depicted nerve agents being carried in glass beads or spheres.`,
  ...
  `Now, as America and Britain invaded Iraq, Bashar decided that he would copy his father.`,
  ...
  `And it grew.`,
  `Within a year, almost all of the foreign fighters from across the world were coming through Syria...`,
  ...
  `Public relations, academics, television presenters, spies, and even musicians were all going to help reinvent Colonel Gaddafi.`,
  ...
  `"Today, in Tripoli, the leader of Libya, Colonel Muammar al-Gaddafi publically confirmed his commitment to disclose and dismantle all weapons-of-mass-destruction programs in his country."`,
  ...
  `His nuclear program had stuttered to a halt long ago and never produced anything dangerous.`,
  ...
  `He said that his father was simply pretending that he had been behind the Lockerbie bombing to get the sanctions lifted.`,
  `That new lies were being built on top of old lies to construct a completely make-believe world.`,
  `"You have to accept, or you had to accept at the time, a responsibility."`,
  `"Because you have to accept responsibilities."`,
  ...
  `"So, what you're saying is that you accept responsibility, but you're not admitting that you did it."`,
  `"Yes."`,
  ...
  `When he was in New York, Gaddafi was offered a tent, just like the one he had at home, in the gardens of a grand mansion.`,
  ...
  `They turned instead to another world that was free of this hypocrisy and the corruption of politics They went into cyberspace.`,
  ...
  `Nothing more.`,
  `One of the early utopians of cyberspace, Jaron Lanier, warned of the implications of this.`,
  `"The agent's model of what you are interested in will always be a cartoon."`,
  `"And in return you will see a cartoon version of the world through the agent's eyes."`,
  `And, he added, "It will never be clear "who they are working for - you or someone else."`,
  ...
  `He was a journalist for the Wall Street Journal and had been kidnapped by radical Islamists in Pakistan.`,
  ...
  `One program was called Optic Nerve.`,
  ...
  `The program did not discover a single terrorist.`,
  `But it did discover something else.`,
  `A top secret assessment said...`,
  `But increasingly, people were using the internet in other ways - to present themselves as THEY wanted to be seen.`,
  ...
  `"Stop..."`,
  `"I nearly..."`,
  `"Threw my phone away! Stop! Stop! Pose. Pose."`,
  `"And snap a selfie..."`,
  `[PHONE CAMERA WHIRS]`,
  ...
  `What drove the Occupy movement was the original dream of the internet that people like John Perry Barlow had outlined in the early 1990s.`,
  ...
  `He worked for Google in Egypt but he had also set up the Facebook site that played the key role in organising the first protests.`,
  `As hundreds of thousands took over Tahrir Square, Ghonim gave an interview on Egyptian TV.`,
  `But Ghonim was also overwhelmed by the power this new technology had, that a computer engineer with a keyboard could call out thousands of people...`,
  `Some of whom then died in the midst of the protests.`,
  `Many liberals in the West saw this as proof of the revolutionary power of the internet.`,
  ...
  `So when an uprising began in Libya, Britain, France and America supported it.`,
  ...
  `His son Saif said, "The way these people are disowning me and my father is disgusting."`,
  `"Just a few months ago, we were being treated as honored friends."`,
  ...
  `"If I had a position, if I were a president, I would have resigned."`,
  ...
  `But instead of becoming a democracy, Libya began to descend into chaos.`,
  ...
  `They arrested the President and killed hundreds of his supporters who protested.`,
  ...
  `He used Kremlin money to sponsor all kinds of groups - from mass anti-fascist youth organisations, to the very opposite - neo-Nazi skinheads and liberal human rights groups who then attacked the government.`,
  ...
  `"And you said recently, 'When you give, they do whatever the hell you want them to do.'"`,
  `"You'd better believe it."`,
  `"So what specifically did they do?"`,
  `"If I ask them, if I need them..."`,
  `"You know, most of the people on this stage, I've given to, just so you understand, a lot of money."`,
  ...
  `"Our country! Proud fucking American! Made in the USA, bitch!"`,
  `"Made in the fucking USA! Don't fucking come back, burrito bitch! Go fucking right back to jail, motherfucker!"`,
  `"Build that fucking wall for me! Trump! Donald Trump! Fuck you! I love my country! Yeah!"`,
  `"I'll fuck like at least ten of you up in one session, you fucking pussy!"`,
  ...
  `[LAUGHTER]`,
  `But underneath the liberal disdain, both Donald Trump in America, and Vladislav Surkov in Russia had realised the same thing - that the version of reality that politics presented was no longer believable, that the stories politicians told their people about the world had stopped making sense.`,
  ...
  `[CHILDREN SING]`,
  `And there was another force that was about to dramatically reveal just how weak politics had become in the West - Syria.`,
  `[CHILDREN SING]`,
  ...
  `"And I'm afraid there is, and we have to be honest and frank about this and talk about these things without being fearful, there is a problem with some of the Muslim community in this country."`,
  `"There is a problem."`,
  ...
  `"I have friends who, like, live and work in London, and they said, "Don't worry, we're a very sensible people.""`,
  `[LAUGHTER]`,
  `"This isn't going to happen."`,
  `"It's a lot of talk, but we don't do that sort of stuff here."`,
  `"Um..."`,
  `"They were wrong."`,
  `[LAUGHTER]`,
